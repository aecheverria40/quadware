"""
Django settings for quadware project.
...
SECRET_KEY = '&b9m@(kf16of(7=4sjfsbv-+hkm&1@dmc_xd-56l9l6(c_wua_'
...
WSGI_APPLICATION = 'quadware.wsgi.application'
...
STATIC_ROOT = 'home/alejandro123/quadware/quadware/static'

# Para tener un correo para poder pedir informacion
